...
During my Season of KDE project, I have worked on modernizing KDE’s documentation PDF generation pipeline by migrating it from `dblatex` to `Apache FOP`.
...
```
## Output PDF generated by dblatex (lang: Ukrainian)
<img width="1212" height="686" alt="Screenshot From 2026-05-26 17-28-02" src="https://github.com/user-attachments/assets/0b4571c6-5b52-4cdc-9ccb-31e531250721" />

## Output PDF generated by Apache FOP (lang:Ukrainian)
<img width="968" height="684" alt="Screenshot From 2026-05-26 17-31-10" src="https://github.com/user-attachments/assets/a1d25efd-9378-4675-97d8-a7538fa988bb" />

As seen from the above example Apache FOP can render UTF-8 encoded text and Unicode texts very efficiently.
